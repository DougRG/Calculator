...
- (void)viewDidLoad {
    ...
    self.displayLabel.backgroundColor = [UIColor yellowColor];
    ...
    NSDictionary *buttonDictionary = NSDictionaryOfVariableBindings(button0, button1, button2, button3, button4, button5, button6, button7, button8, button9, buttonAdd, buttonDivide, buttonSubtract, buttonMultiply, buttonEnter);
    
    NSArray *buttonConstraints = [NSLayoutConstraint constraintsWithVisualFormat:@"H:|[button7][button8][button9][buttonDivide]|" options:NSLayoutFormatAlignAllCenterY metrics:nil views:buttonDictionary];
    [self.view addConstraints:buttonConstraints];
    
    buttonConstraints = [NSLayoutConstraint constraintsWithVisualFormat:@"H:|[button4][button5][button6][buttonMultiply]|" options:NSLayoutFormatAlignAllCenterY metrics:nil views:buttonDictionary];
    [self.view addConstraints:buttonConstraints];
    
    buttonConstraints = [NSLayoutConstraint constraintsWithVisualFormat:@"H:|[button1][button2][button3][buttonSubtract]|" options:NSLayoutFormatAlignAllCenterY metrics:nil views:buttonDictionary];
    [self.view addConstraints:buttonConstraints];
    
    buttonConstraints = [NSLayoutConstraint constraintsWithVisualFormat:@"H:|[button0][buttonEnter][buttonAdd]|" options:NSLayoutFormatAlignAllCenterY metrics:nil views:buttonDictionary];
    [self.view addConstraints:buttonConstraints];
    
    buttonConstraints = [NSLayoutConstraint constraintsWithVisualFormat:@"V:[button7][button4][button1][button0]|" options:NSLayoutFormatAlignAllCenterX metrics:nil views:buttonDictionary];
    [self.view addConstraints:buttonConstraints];
    ...
    NSArray *buttonsHeightArray = @[button0, button1, button2, button3, button4, button5, button6, button7, button8, button9, buttonDivide, buttonAdd, buttonSubtract, buttonMultiply];
    ...
    NSArray *buttonsWidthArray = @[button0, button1, button2, button3, button4, button5, button6, button7, button8, button9, buttonDivide, buttonAdd, buttonSubtract, buttonMultiply];
    ...
    for (int i = 0; i < buttonsWidthArray.count; i++) {
        ...
        NSLayoutConstraint *enterWidthContstraint = [NSLayoutConstraint constraintWithItem:buttonEnter
                                                                                 attribute:NSLayoutAttributeWidth
                                                                                 relatedBy:NSLayoutRelationEqual
                                                                                    toItem:button7
                                                                                 attribute:NSLayoutAttributeWidth
        ...
        [self.view addConstraint:enterWidthContstraint];
...
- (NSNumber *)popOperandStack {
    NSNumber *lastNumber = [NSNumber numberWithDouble:self.displayValue];
...
-(void)operate:(UIButton *)button {
    ...
    if (self.operandStack.count >= 2) {
        NSNumber *var1 = [self popOperandStack];
        NSNumber *var2 = [self popOperandStack];
        
        NSString *operation = button.titleLabel.text;
        
        if ([operation isEqualToString:@"/"]) {
            self.displayValue = [var2 doubleValue] / [var1 doubleValue];
